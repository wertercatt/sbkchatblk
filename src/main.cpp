...
uint256 hashGenesisBlock("0x2d71a9288ba096a2ca0d2373214ba9f0890541a58bb5f3bd2dc3e627642712b6");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // SBKBlockChat: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "SBKBlockChat Signed Message:\n";
...
{
    // SBKBlockChat: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    int64 nSubsidy = 15000000000;

    // Subsidy is cut in half every 840000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 250000); // SBKBlockChat: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // SBKBlockChat: 3.5 days
static const int64 nTargetSpacing = 150; // SBKBlockChat: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // SBKBlockChat: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // SBKBlockChat: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // SBKBlockChat: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x276bb92194724b62317e059d5ebf5c4d76bdb12fd8f25e69b3b4bf97c9d2bbd3");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "SouthBank Block Chat System";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 15000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("73912e4e46247184d729350ee9665232b5380f9cc789376b1f4653b5b3541697c1e3664b7f624877e2082d157997f05999f2bfaf91965287b27165772ab361b5e8") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1468238040;
        block.nBits    = 504365644;
        block.nNonce   = 2099430390;

        if (fTestNet)
        {
            block.nTime    = 1468238040;
            block.nNonce   = 3908863377;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x35d12ac036d86a2451524281484687dac2211b61688ae5018c21fb38a6a69356"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // SBKBlockChat: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("SBKBlockChatMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("SBKBlockChatMiner : ProcessBlock, block not accepted");
    }
